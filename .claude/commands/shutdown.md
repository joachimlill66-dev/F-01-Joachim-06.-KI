...
2. Scanne alle Verzeichnisse:
   - `01_context/` — Sind alle Dateien aktuell? Gibt es veraltete Einträge?
   - `05_plans/` — Gibt es Pläne mit Status "Draft", die auf "Implemented" stehen sollten?
   - `09_Marktueberblick/` — Gibt es temporäre oder verwaiste Dateien?
   - `03_scripts/` — Gibt es unbenutzte Skripte?
   - `04_reference/` — Gibt es veraltete Referenzdokumente?
...
Prüfe jede Datei in `01_context/`:
...
### Schritt 5: Automatisches Tagebuch (10_Tagebuch)

1. Erstelle eine neue Markdown-Datei im Ordner `10_Tagebuch/` mit dem aktuellen Datum (z.B. `2026-06-16-tagebuch.md`).
2. Fasse die Highlights der gesamten Sitzung zusammen: Marktbeobachtungen, Portfolio-Analysen und System-Anpassungen.

### Schritt 6: Git — Committen und Pushen
