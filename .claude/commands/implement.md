...
plan_pfad: $ARGUMENTS (Pfad zur Plan-Datei, z.B. `05_plans/2026-01-28-gaeste-recherche-command.md`)
...
### Plan-Status
`05_plans/YYYY-MM-DD-{name}.md` Status auf "Implementiert" aktualisiert
```
